...
namespace MyValidator
{
	...
	/// <returns>生成的数组</returns>
	vector<int> randomArray1(int maxLen, int max, bool isSorted = true);
	...
	/// <param name="isSorted">是否对数组进行排序</param>
	/// <returns>生成的数组</returns>
	vector<int> randomArray2(int maxLen, int max, bool isSorted);
	...
	string randomString(int maxLen, const string& exaction = "GB");
